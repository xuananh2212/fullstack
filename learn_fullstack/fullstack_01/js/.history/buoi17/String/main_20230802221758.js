...
var welcome = "chao mung ban den voi dem";

var wordFirst = welcome.slice(0, welcome.indexOf(""));
var wordLast = welcome.slice(welcome.indexOf(""), welcome.length);

var c = welcome.replace(wordLast, wordFirst);

c.replace(wordFirst, wordLast);
