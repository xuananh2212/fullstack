...
// 14. sort() => sap xep mang theo thu tu tang dan
...
var cust = customers.sort((a, b) => {
  var firstNameA = a.split(" ");
  var firstNameb = b.split(" ");

  if (firstNameA[firstNameA.length - 1] > firstNameb[firstNameb.length - 1]) {
    return 1;
  } else {
    return -1;
  }
